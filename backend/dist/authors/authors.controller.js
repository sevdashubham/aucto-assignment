...
let AuthorsController = class AuthorsController {
    ...
    addAuthor(authorDto) {
        ...
        const generatedId = this.authorsService.insertAuthor(name);
...
__decorate([
    ...
    __metadata("design:paramtypes", [author_dto_1.AuthorRouteDto]),
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], AuthorsController.prototype, "getAuthor", null);
